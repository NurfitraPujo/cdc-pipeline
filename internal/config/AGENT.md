...
- **Autonomous Supervision**:
    ...
    - Triggers automatic restarts with a 5-second stabilization delay.
    - **Note**: Exponential backoff is planned but not yet implemented (currently uses fixed 5-second delay).
