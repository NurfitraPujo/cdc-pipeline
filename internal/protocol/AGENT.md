...
- **Data Models**:
    - **`Message`**: The fundamental unit of CDC data, containing table info, operation type (insert/update/delete/snapshot), LSN, and payload. Now includes **Correlation IDs** for secured acknowledgments and transformation lineage.
